...
/* @var $searchModel backend\models\search\BrokerEmailSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Broker Emails';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="broker-email-index">
    ...
    <p>
        <?= Html::a('Create Broker Email', ['create'], ['class' => 'btn btn-success']) ?>
