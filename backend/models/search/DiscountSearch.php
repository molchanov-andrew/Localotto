...
/**
 * DiscountSearch represents the model behind the search form of `common\models\records\Discount`.
 */
class DiscountSearch extends Discount
{
    ...
    {
        return [
            [['id', 'brokerToLotteryId', 'limit'], 'integer'],
            [['discount', 'description', 'created', 'updated'], 'safe'],
        ];
    }
