...
class DiscountController extends Controller
{
    ...
    {
        $model = new Discount(['brokerToLotteryId' => $this->brokerToLottery->id]);
    ...
    public function actionChangeMultiple()
    {
        ...
        if(Yii::$app->request->post()) {
            $response = Discount::changeMultiple(Yii::$app->request->post());
            return $response->render();
        }

        return $this->renderAjax('@app/views/ui/change-multiple', [
            'model' => $model,
            'formFile' => '@app/views/discount/_form',
        ]);
    }
    ...
    {
        if(Yii::$app->request->post()){
            $response = Discount::deleteMultiple(Yii::$app->request->post());
        } else {
